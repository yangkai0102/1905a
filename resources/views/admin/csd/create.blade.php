            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="post" action="{{url('admin/csd/store')}}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="kh_name" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="csd_money"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-12">服务类型描述</label>
                                        <div class="col-sm-12">
                                            <textarea rows="5" name="csd_desc" class="form-control form-control-line"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
