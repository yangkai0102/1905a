                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">联系人</th>
                                                <th scope="col">预估成本</th>
                                                <th scope="col">服务类型描述</th>
                                                <th scope="col">客户满意度</th>
                                                <th scope="col">操作</th>
                                            </tr>
                                        </thead>
                                        @foreach($data as $v)
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$v->kh_name}}</td>
                                                <td>{{$v->user_name}}</td>
                                                <th scope="col">{{$v->csd_money}}</th>
                                                <th scope="col">{{$v->csd_desc}}</th>
                                                <th scope="col">
                                                    @if($v->kh_desc==1)
                                                    很满意
                                                        @elseif($v->kh_desc==2)
                                                ...
                                                <th scope="col">
                                                    <a href="{{url('admin/csd/edit/'.$v->csd_id)}}">编辑</a>
                                                    <a href="{{url('admin/csd/destroy/'.$v->csd_id)}}">删除</a>
                                                </th>
                                            </tr>
